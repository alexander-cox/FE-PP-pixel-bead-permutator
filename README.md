...
Open [https://pixel-bead-permutator.herokuapp.com/](https://pixel-bead-permutator.herokuapp.com/) to view it in the browser.
...
```json
{
  ...
  "configurations": [{
    ...
    "type": "chrome",
    "request": "launch",
    "url": "https://pixel-bead-permutator.herokuapp.com/",
...
In the WebStorm menu `Run` select `Edit Configurations...`. Then click `+` and select `JavaScript Debug`. Paste `https://pixel-bead-permutator.herokuapp.com/` into the URL field and save the configuration.
...
```
Fetch API cannot load http://localhost:4000/api/todos. No 'Access-Control-Allow-Origin' header is present on the requested resource. Origin 'https://pixel-bead-permutator.herokuapp.com/' is therefore not allowed access. If an opaque response serves your needs, set the request's mode to 'no-cors' to fetch the resource with CORS disabled.
```
